...
public class NotesTabTestCase extends Setup {
	...
	@Test(priority = 0, dataProvider = "getNotesDataReader", dataProviderClass = ReadData.class, groups = {
			"regression" })
	...
	@Test(priority = 1, dataProvider = "getNotesDataReader", dataProviderClass = ReadData.class, groups = {
			"regression" })
	...
	@Test(priority = 2, dataProvider = "getNotesDataReader", dataProviderClass = ReadData.class, groups = {
			"regression" })
