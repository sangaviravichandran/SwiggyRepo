...
public class CommonUtils extends Setup implements InterfaceConstants {
	...
	public void Actionleft(WebElement element) throws Exception {
	...
	void metho() {
		WebElement findElement = driver.findElement(By.tagName("pf-section"));
		WebElement shadow = expandRootElement(findElement);
		WebElement findElement2 = shadow.findElement(By.tagName("pf-text"));
		
	}
	
	
	public static WebElement expandRootElement(String element) {
		WebElement ele = null;
		try {
	...
	public void loadURL() throws Exception {
		...
		driver.get(ReadData.getProperty(System.getProperty("environment")));
	}
	...
	public void NAPFBrowserLaunch() throws Exception {
		...
		this.browserLaunch(System.getProperty("browser"));
