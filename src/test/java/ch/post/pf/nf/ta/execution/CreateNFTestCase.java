...
public class CreateNFTestCase extends Setup {
	...
	/*
	 * This Testcase help on Create investigation and Enter the value in process
	 * name and TA name
	 */
	...
	/*
	 * This Testcase help on after create investigation and general Tab all field
	 * validation
	 */
	...
	/*
	 * This Testcase help on after create investigation Closure Field validation in
	 * general tab
	 */
		...
		try {
			...
			if (testdata.get(CAN_EXECUTE).equalsIgnoreCase(YES)) {
				...
				if (testdata.get(HEADERS).equalsIgnoreCase("Online")) {
					...
					daoTest.searchAndMovetoUserinbox(testdata.get(LANGUAGE), testdata.get(MENU_1), testdata.get(NFID));
					scenario.DcClosureFieldDataValidation(testdata);
				}
			} else {
				logger = parent.createNode(methodName + testdata.get("Menu 1"));
	...
	/*
	 * This Testcase help on after create investigation Product Code Data validation
	 * in general tab
	 */
	...
	/*
	 * This Testcase help on after create investigation Local code data validation
	 * in general Tab
	 */
