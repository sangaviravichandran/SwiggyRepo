...
public class ReadData {
	...
	private static final String testcasefilepath ="C:\\NAPF_Test\\TestCases.xls";
	...
	public static Map<String, String> readDataField(String sheetName) throws Exception {
		FileInputStream fi = (FileInputStream) ReadData.class.getClass().getResourceAsStream("/MasterFile.xls");
		...
		for (int i = 1; i < physicalNumberOfRows; i++) {
			...
			for (int j = 0; j < physicalNumberOfCells; j++) {
				...
				case NUMERIC:
					...
					break;
				case FORMULA:
					RichTextString cellFormula = cell.getRichStringCellValue();
